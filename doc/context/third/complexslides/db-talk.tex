...
\startslide[title={Picture slide}]
  ...
  % \scale[scale=500]{\externalfigure[cow][frame=on]}
  \externalfigure[cow]
\stopslide

\startslide[title={Picture slide}]%
  \framedtext[height=\dimexpr\textheight-1mm\relax,width=\textwidth]{TEST}
  \page[yes]
  \framedtext[height=\dimexpr\textheight-1mm\relax,width=\textwidth]{TEST}
%  \startframedtext[height=\dimexpr\textheight-1mm\relax,width=\textwidth] TEST \stopframedtext
%  \page[yes]
%  \startframedtext[height=\dimexpr\textheight-1mm\relax,width=\textwidth] TEST \stopframedtext
\stopslide
