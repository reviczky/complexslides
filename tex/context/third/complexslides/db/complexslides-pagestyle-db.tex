...
\startreusableMPgraphic {complexslides:pagebackground:logo} {color}
  drawoptions (withcolor \MPvar{color});
  input db-logo;
\stopreusableMPgraphic

\startreusableMPgraphic {complexslides:pagebackground:identifier} {color}
  drawoptions (withcolor \MPvar{color});
  input db-identifier;
\stopreusableMPgraphic
...
\setlayer[complexslides:pagebackground:image:bridge1][hoffset=0mm,voffset=0mm]{\externalfigure[http://staging.integration.chris.dweb.ies.gto.intranet.db.com/banner/10ee9zp.jpg][width=\paperwidth]}
