\startmodule complexslides-pagestyle-db
...
\setlayer[complexslides:pagebackground:identifier][hoffset=7mm,voffset=14mm]{\startframedtext[frame=on] \switchtobodyfont[13.5pt]\color[foreground:4]{Deutsche Bank}\\\color[brightblue]{Group Technology}}\scale[height=10mm]{\useMPgraphic{complexslides:pagebackground:identifier}{color=background:0} \stopframedtext}
