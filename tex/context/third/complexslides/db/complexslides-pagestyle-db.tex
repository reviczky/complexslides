...
\setlayer[complexslides:pagebackground:identifier][hoffset=7mm,voffset=14mm]{\startframed[frame=on,align=flushleft,width=fit]\switchtobodyfont[14pt]\setupinterlinespace[off]\color[foreground:4]{Deutsche Bank}\\\color[brightblue]{Group Technology}\par\stopframed}
