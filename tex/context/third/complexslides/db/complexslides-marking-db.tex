...
\startsetups[identifier] \startframed[frame=on,align=flushleft,width=fit]\switchtobodyfont[14pt]\setupinterlinespace[off]\color[dbblue]{Deutsche Bank}\\\color[brightblue]{Group Technology}\par\stopframed \stopsetups
