...
\startreusableMPgraphic {identifier} {color}
...
\startsetups[identifier] \framed[frame=on,width=fit]{\scale[height=10mm]{\reuseMPgraphic{identifier}{color=dbblue}}} \stopsetups
\startsetups[event] \startframedtext[middle][frame=on,width=fit,offset=0mm,strut=no] \getvariable{talk}{shortauthor} \\ \getvariable{talk}{shorttitle} \stopframedtext \stopsetups
